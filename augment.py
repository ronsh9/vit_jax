# deit code is taken from: https://github.com/facebookresearch/deit/blob/main/augment.py
# mae code is taken from: https://github.com/facebookresearch/mae/blob/efb2a8062c206524e35e47d04501ed4f544c0ae8/main_pretrain.py#L123
...
def deit_data_aug_generator(config):
    img_size = config.dataset.input_size
    remove_random_resized_crop = config.dataset.aug.src
    ...
    color_jitter = config.dataset.aug.color_jitter
